...
-- object: "FK_MAE_CRON_MAE_TIPO_OBJ" | type: CONSTRAINT --
-- ALTER TABLE public."MAE_CRON" DROP CONSTRAINT IF EXISTS "FK_MAE_CRON_MAE_TIPO_OBJ" CASCADE;
ALTER TABLE public."MAE_CRON" ADD CONSTRAINT "FK_MAE_CRON_MAE_TIPO_OBJ" FOREIGN KEY (tobj_id)
REFERENCES public."MAT_TIPO_OBJ" (tobj_id) MATCH SIMPLE
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --

-- object: "FK_MAE_CRON_TAB_PROTOCOLO" | type: CONSTRAINT --
-- ALTER TABLE public."MAE_CRON" DROP CONSTRAINT IF EXISTS "FK_MAE_CRON_TAB_PROTOCOLO" CASCADE;
ALTER TABLE public."MAE_CRON" ADD CONSTRAINT "FK_MAE_CRON_TAB_PROTOCOLO" FOREIGN KEY (prot_id)
REFERENCES public."TAB_PROTOCOLO" (prot_id) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
